  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
        <form className='flex flex-wrap w-full items-start justify-between  ' >
            <div className='w-1/2'>
                <div>
                    <h3 className='text-l text-gray-300 mb-0.5 '>Task Title</h3>
                ...
                <div>
                    <h3 className='text-l text-gray-300 mb-0.5 '>Category</h3>
            ...
            <div className='w-2/5 flex flex-col items-start'>
                ...
                <textarea className='text-sm py-2 px-4  w-full rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' name="" id="" cols="30" rows="10"></textarea>
